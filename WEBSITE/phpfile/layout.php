      ...
      <div class="flex h-screen bg-[#fbfbfe]">
        <aside class="w-80 hidden md:flex md:flex-col border m-4 mr-0 rounded-lg overflow-hidden">
          ...
          <div class='flex relative my-1 cursor-pointer'>
            <a class='ml-8 flex p-1 w-full rounded-xl text-[#008ee0] mr-4'  id="#dashboard" onclick="showPage('dashboard')">
          ...
          <div class="flex flex-col mr-4">
            <div class="flex relative my-1 cursor-pointer">
              <a class='flex relative my-1 w-full'   onclick="showPage('analytics')">
            ...
            <div class='flex relative my-1 cursor-pointer'>
              <a class='ml-8 flex p-1 w-full rounded-xl mr-4' onclick="showPage('reports')">
                <span class='flex items-center gap-1 px-1'>
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                    stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
            ...
            <div class="flex relative my-1 cursor-pointer">
              <a class='flex relative my-1 w-full' onclick="showPage('coreoperation')">
            ...
            <div class='flex relative my-1 cursor-pointer'>
              <a class='ml-8 flex p-1 w-full rounded-xl mr-4' onclick="showPage('drivermanagement')">
                <span class='flex items-center gap-1 px-1'>
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor"
                    class="icon icon-tabler icons-tabler-filled icon-tabler-layout-dashboard">
                    <path stroke="none" d="M0 0h24v24H0z" fill="none" />
            ...
            <div class='flex relative my-1 cursor-pointer'>
              <a class='ml-8 flex p-1 w-full rounded-xl mr-4' onclick="showPage('fleetmanagement')">
                <span class='flex items-center gap-1 px-1'>
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                    stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                    class="icon icon-tabler icons-tabler-outline icon-tabler-clipboard-data">
        ...
        <div class='flex flex-col w-full h-screen overflow-y-scroll'>
          <nav
            ...
            <div class="flex w-full">
              ...
              <div class="relative flex justify-between w-full">
                <div class="mx-4 my-4 font-medium text-3xl">...</div>
                <button type="button"
          ...
          <!-- CORE OPERATION -->
          <div class="coreoperation hidden">
             <?php include "coreoperation.php";?>
          </div>

          <div class="drivermanagement hidden">
             <?php include "drivermanagement.php";?>
          </div>

          <div class="fleetmanagement hidden">
             <?php include "fleetmanagement.php";?>
          </div>
